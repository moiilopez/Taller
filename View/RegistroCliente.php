        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="../View/RegistroCliente.php" class="active-menu"><i class="fa fa-user"></i> Registro de Cliente</a>
                    </li>
                    <li>
...
<!--                    <li>
		...
		<div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="../Controller/ClienteController.php?action=registrar" method="post" role="form">
