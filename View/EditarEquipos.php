        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"><i class="fa fa-pencil"></i> Editar Equipo</a>
                    </li>
<!--                    <li>
		...
		<div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="../controller/EquipoController.php?action=editar" method="post" role="form">
                                <?php 
                                if(!empty($resultadoEquipo)):
                                ?>
                                <div class="form-group">
                                    <label for="id">Codigo:</label>
                                    <input class="form-control" name="id" disabled value="<?php echo $resultadoEquipo[0]['id'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="tipo">Tipo:</label>
                                    <input class="form-control" name="tipo" value="<?php echo $resultadoEquipo[0]['tipo'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="modelo">Modelo:</label>
                                    <input class="form-control" name="modelo" value="<?php echo $resultadoEquipo[0]['modelo'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="marca">Marca:</label>
                                    <input class="form-control" name="marca" value="<?php echo $resultadoEquipo[0]['marca'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="serial">Numero de Serie:</label>
                                    <input class="form-control" name="serial" value="<?php echo $resultadoEquipo[0]['serial'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="problema">Problema:</label>
                                    <input class="form-control" name="problema" value="<?php echo $resultadoEquipo[0]['problema'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="fecha">Fecha:</label>
                                    <input class="form-control" name="fecha" value="<?php echo $resultadoEquipo[0]['fecha'] ?>" >
                                </div>
                                <div class="form-group">
                                    <label for="cliente">Cliente:</label>
                                    <input class="form-control" name="cliente"  disabled value="<?php echo $resultadoEquipo[0]['cliente_Nombre'] ?>" >
                                </div>
                                <input type="hidden" name="hiddenId" value="<?php echo $resultadoEquipo[0]['id'] ?>">
