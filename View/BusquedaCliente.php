        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="../View/BusquedaCliente.php" class="active-menu"><i class="fa fa-search"></i> Buscar Cliente</a>
                    </li>
...
<!--                    <li>
		...
		<div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="../Controller/ClienteController.php?action=buscar" method="post" role="form">
                                <div class="form-group">
                                    <label for="nombre">Digite el nombre del cliente:</label>
                                    <input class="form-control" name="nombre" >
                                </div>
                                <div class="form-group">
                                    <label for="codigo"> Digite el codigo del cliente:</label>
                                    <input class="form-control" name="codigo" >
                                </div>
                                <div class="form-group">
                                    <label for="Documento">Digite el R.U.T. o C.I. del Cliente:</label>
                                    <input class="form-control" name="documento" >
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" name="estado" value="off">
                                    <label class="checkbox-inline" for="estado">Buscar en desactivados</label>
                                </div>
