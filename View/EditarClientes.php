        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"><i class="fa fa-pencil"></i> Editar Cliente</a>
                    </li>
<!--                    <li>
		...
		<div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="../controller/ClienteController.php?action=editar" method="post" role="form">
                                <?php 
                                if(!empty($resultadoCliente)):
                                ?>
                                <div class="form-group">
                                    <label for="id">Codigo:</label>
                                    <input class="form-control" name="id" disabled value="<?php echo $resultadoCliente[0]['id'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nombre">Nombre:</label>
                                    <input class="form-control" name="nombre" value="<?php echo $resultadoCliente[0]['nombre'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="telefono">Telefono:</label>
                                    <input class="form-control" name="telefono" value="<?php echo $resultadoCliente[0]['telefono'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="direccion">Direccion:</label>
                                    <input class="form-control" name="direccion" value="<?php echo $resultadoCliente[0]['direccion'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="localidad">Localidad:</label>
                                    <input class="form-control" name="localidad" value="<?php echo $resultadoCliente[0]['localidad'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="fecha">Fecha:</label>
                                    <input class="form-control" name="fecha" value="<?php echo $resultadoCliente[0]['fecha'] ?>" >
                                </div>
                                <div class="form-group">
                                    <label for="documento">Documento:</label>
                                    <input class="form-control" name="documento" value="<?php echo $resultadoCliente[0]['documento'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="descuentos">Descuentos:</label>
                                    <input class="form-control" name="descuentos"  disabled value="<?php echo $resultadoCliente[0]['descuentos'] ?>" >
                                </div>
                                <input name="hiddenId" type="hidden" value="<?php echo $resultadoCliente[0]['id'] ?>">
