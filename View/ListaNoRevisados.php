...
<head>
    ...
    <title>Equipos No Revisados</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"><i class="fa fa-list-alt"></i> Equipos Sin Revisar</a>
                    </li>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($resultadoEquipo as $equipo) :
                                                ...
                                                if ($equipo['Equipo_Id'] == NULL && $equipo['Problem'] == NULL && $equipo['InfTecnico'] == NULL && 
                                                    $equipo['InfCliente'] == NULL && $equipo['ValPre'] == NULL && $equipo['Extras'] == NULL && 
                                                    $equipo['ValEx'] == NULL && $equipo['Total'] == NULL && $equipo['Status'] == NULL):
                                                ?>
                                                <tr>
