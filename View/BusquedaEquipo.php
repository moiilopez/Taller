        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="../View/BusquedaEquipo.php" class="active-menu"><i class="fa fa-search"></i> Buscar Equipo</a>
                    </li>
<!--                    <li>
		...
		<div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="../Controller/EquipoController.php?action=buscar" method="post" role="form">
                                ...
                                <div class="form-group">
                                    <label for="serial"> Ingrese el numero de serie:</label>
                                ...
                                <div class="form-group">
                                    <label for="cliente"> Ingrese el nombre del cliente:</label>
