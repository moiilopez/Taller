        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"><i class="fa fa-list-alt"></i> Lista de Clientes</a>
                    </li>
<!--                    <li>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        ?>    
                                            ...
                                            <td><a href="../view/cliente.php?clienteId=<?php echo$cliente['id'];?>"><button class="btn btn-info btn-sm"><?php echo$cliente['nombre']?></button></a></td>
                                            <td><?php echo$cliente['direccion']?></td>
                                            <td><?php echo$cliente['telefono']?></td>
                                            <td><?php echo$cliente['localidad']?></td>
                                            <td><?php echo$cliente['documento']?></td>
                                            <td><?php echo$activo?></td>
                                            <td> <a href="../Controller/ClienteController.php?clienteId=<?php echo$cliente['id']?>&action=consultar"><button class="btn btn-warning btn-sm">Editar</button></a>
                                                 <a href="../Controller/ClienteController.php?clienteId=<?php echo$cliente['id']; ?>&action=<?php echo$cambiar?>"><button class="btn btn-danger btn-sm"><?php echo$cambiar; ?></button></a></td>
                                            </tr>
                                        <?php
                                        endforeach;
                                        ?>
